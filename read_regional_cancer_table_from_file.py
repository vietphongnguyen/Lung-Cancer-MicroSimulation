...
def read_regional_cancer_table_from_file(file_name):
    print("Reading Regional Cancer table from file [" + file_name + "] ...", end="")
    ...
    input_worksheet = input_workbook.sheet_by_name("Survival rate-Regional cancer")
